// Best time to buy and sell stock You are given an 
// array prices where prices[i] is the price of a 
// given stock on the ith day.You want to maximize 
// your profit by choosing a single day to buy one 
// stock and choosing a different day in the future 
// to sell that stock.Return the maximum profit 
...
// Note that buying on day 2 and selling onday 1 is not 
...
// the maxprofit = 0 Constraints: 1 <= prices.length <= 105 
// 0 <= prices[i] <= 104
